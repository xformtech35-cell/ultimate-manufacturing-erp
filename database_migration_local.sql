-- ============================================================
-- DATABASE MIGRATION SCRIPT - LOCAL ENVIRONMENT (Universal MySQL Compatible)
-- Database: ultimate-manufacturing-erp
-- Prefix: sameepaccounting_
-- ============================================================

-- Step 1: Add allowed_overrun_pct to sameepaccounting_inventory
...
-- Step 2: Add overrun tracking columns to sameepaccounting_material_issue_items
...
-- Step 4: Add allowed_overrun_pct override column to sameepaccounting_bom
