...
<style>
    ...
    #dynamic_field th:nth-child(1),
    #dynamic_field td:nth-child(1) { width: 12%; } /* Item */
    
    #dynamic_field th:nth-child(2),
    #dynamic_field td:nth-child(2) { width: 8%; } /* Description */
    
    #dynamic_field th:nth-child(3),
    #dynamic_field td:nth-child(3) { width: 7%; } /* HSN Code */
    
    #dynamic_field th:nth-child(4),
    #dynamic_field td:nth-child(4) { width: 5%; } /* QTY */
    ...
    #dynamic_field th:nth-child(5),
    #dynamic_field td:nth-child(5) { width: 8%; } /* UNIT */
    
    #dynamic_field th:nth-child(6),
    #dynamic_field td:nth-child(6) { width: 8%; } /* GST */
    
    #dynamic_field th:nth-child(7),
    #dynamic_field td:nth-child(7) { width: 8%; } /* SGST */
    
    #dynamic_field th:nth-child(8),
    #dynamic_field td:nth-child(8) { width: 8%; } /* CGST */
    
    #dynamic_field th:nth-child(9),
    #dynamic_field td:nth-child(9) { width: 8%; } /* Price */
    
    #dynamic_field th:nth-child(10),
    #dynamic_field td:nth-child(10) { width: 0%; } /* Discount (hidden) */
    
    #dynamic_field th:nth-child(11),
    #dynamic_field td:nth-child(11) { width: 12%; } /* Amount */
    
    #dynamic_field th:nth-child(12),
    #dynamic_field td:nth-child(12) { width: 16%; } /* Action */
                    ...
                    <div class="pull-left">
                        ...
                        <div class="col-md-2">
                            <!--<a href="<?php //echo base_url();   
                                            ?>SalesOrderController/create_salesorder" id="non_gst" name="non_gst" class="btn btn-primary" role="button">Non GST</a>-->
                        </div>
                        <div class="pull-right">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo base_url(); ?>SalesOrderController/create_igst_salesorder" id="central_igst" name="central_igst" class="btn btn-primary" role="button">IGST</a>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Create GST Sales Order</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <input type="hidden" name="salesorder_gst_check" value="gst" id="salesorder_gst_check">
                                                <label class="col-sm-12 control-label" style="text-align: right;">
                                                    <h2>GST Sales Order: <b id="so_number_display"></b></h2>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Delivery Date<span style="color: red;">*</span></label>
                                                <div class="col-sm-8">
                                     ...
                                     <div class="table-responsive">
                                         ...
                                         <table class="table table-bordered" id="dynamic_field">
                                             ...
                                             <tbody id="table-body">
                                                 <tr id="row1">
                                                     <td>
                                                         <select class="form-control input-sm product_name_auto item_search_name name_list" name="product_name[]" id="item_name1" onchange="myFunction1(this.id)" required="" data-live-search="true" style="max-width: 100%;" disabled>
                                                             <option></option>
                                        ...
                                        <div align="right" style="margin: 10px">
                                            ...
                                            <span id="basic_total_display" style="font-weight: bold; color: #333;">Total before Tax: ₹0.00</span><br>
...
function updateTotalBeforeTax() {
    ...
    $('#basic_total_display').text('Total before Tax: ₹' + total.toFixed(2));
...
// Function to calculate and display SGST amount
function updateSGSTAmount() {
    let sgstTotal = 0;
    
    // Sum all sgst[] values
    $('input[name="sgst[]"]').each(function() {
        let sgstValue = parseFloat($(this).val()) || 0;
        sgstTotal += sgstValue;
    });
...
// Function to calculate and display CGST amount
function updateCGSTAmount() {
    let cgstTotal = 0;
    
    // Sum all cgst[] values
    $('input[name="cgst[]"]').each(function() {
        let cgstValue = parseFloat($(this).val()) || 0;
        cgstTotal += cgstValue;
    });
...
function updateGrandTotal() {
    ...
    let grandTotal = basicTotal + sgstTotal + cgstTotal;
...
$(document).ready(function() {
    ...
    // Update every time quantity, price, amount, sgst, or cgst values change
    $(document).on('change input', 'input[name="quantity[]"], input[name="price[]"], input[name="amount[]"], input[name="amount_temp[]"], input[name="sgst[]"], input[name="cgst[]"]', function() {
        updateTotalBeforeTax();
    });
