                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay" name="add_name" id="add_name" method="post"
                                    action="<?php echo base_url(); ?>EstimateController/add_estimate_quotation"
                                    enctype="multipart/form-data">
                                    <div class="row">

                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                <input type="hidden" name="quotation_non_gst_check" value="non_gst"
                                                    id="quotation_non_gst_check">
                                                <input type="hidden" class="form-control input-sm" name="number"
                                                    id="number" required=""
                                                    value="NGQUOTE/<?php echo date("Y"); ?>/<?php echo strtoupper(date("M")); ?>/<?php printf("%04d", $non_gst_quotation_id['COUNT(uid)'] + 1); ?>">
                                                <label for="inputEmail3" name="number" id="number"
                                                    class="col-sm-12 control-label">
                                                    <h2>Non GST Quotation:<b>
                                                            NGQUOTE/<?php echo date("Y"); ?>/<?php echo strtoupper(date("M")); ?>/<?php printf("%04d", $non_gst_quotation_id['COUNT(uid)'] + 1); ?>
                                                        </b></h2>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-5 control-label">Company<span
                                                        style="color: red;">*</span></label>

                                                <div class="col-sm-7" id="append_to_dropdown">

                                                    <select id="customer_id" name="customer_id"
                                                        class="form-control company_search_name" required="">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row ">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Date<span
                                                        style="color: red;">*</span></label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control date input-sm created-date"
                                                        name="date" id="date" required="" onkeydown="return false;">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-4 control-label">Expires on<span
                                                        style="color: red;">*</span></label>
                                                <div class="col-sm-8">
                                                    <input type="text"
                                                        class="form-control date input-sm payment-due-date-check"
                                                        name="expires_date" id="expires_date" required=""
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text"
                                                        value="<?php echo $settings['quotation_subheading']; ?>"
                                                        class="form-control" name="quotation_subheading"
                                                        id="quotation_subheading">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="quotation_footer"
                                                        id="quotation_footer"
                                                        rows="3"><?php echo $settings['quotation_footer']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="quotation_memo"
                                                        id="quotation_memo"
                                                        rows="3"><?php echo $settings['quotation_memo']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                            ...
                                            <tr>
                                                <td>
                                                    <select style="width: 150px"
                                                        ...
                                                        name="term[]" id="item_name1" onchange="myFunction(this.id)"
                                                        required="" data-live-search="true">
                                                        <option></option>
                                                        <?php foreach ($product_name as $key) { ?>
                                                        <option value="<?php echo $key->barcode; ?>">
                                                            <?php echo $key->barcode; ?></option>
                                                        <?php } ?>
                                                    </select>

                                                </td>
                                                <td><input type="text" name="description[]" id="description1"
                                                        class="form-control input-sm name_list description_auto" /></td>
                                                <td class="hide"> <span id="total_quantity1"
                                                        name="total_quantity[]"></span></td>
                                                <td><input type="number" min="1" name="quantity[]" id="quantity1"
                                                        required=""
                                                ...
                                                <td><input type="text" readonly="" name="hsn[]" id="hsn1" required=""
                                                        class="form-control input-sm required_list name_list" /></td>
                                                <td class="hide"><input type="text" name="gst_per[]" id="gst_per1"
                                                        class="form-control input-sm name_list" /></td>
                                                <td><input type="text" readonly="" name="price[]" id="price1"
                                                        required=""
                                                ...
                                                <td><button type="button" name="edit_non_gst" id="edit_non_gst"
                                        ...
                                        <div align="right" style="margin: 10px">
                                            <input type="hidden" name="temp_total" id="temp_total"
                                                class="form-control input-sm temp_total" value="0.00" /><br>
                                            <span id="total_amount" name="total_amount"><b>Grand Total:</b>
                                                ₹0.00</span><br>
                                            <span class="text" id="grand_total_amount"><b>Grand Total:</b> ₹0.00</span>
                                            <input type="hidden" name="basic_total" id="basic_total"
                                                class="form-control input-sm basic_total" value="0.00" />
                                            <span class="hide" id="sgst_amount" name="sgst_amount[]">SGST Amount:
                                                ₹0.00</span><br>
                                            <span class="hide" id="cgst_amount" name="cgst_amount[]">CGST Amount:
                                                ₹0.00</span><br>
                                            <span class="hidden" id="total_gst_amount" name="total_gst_amount[]">Total
                                                GST Amount: ₹0.00</span><br>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" maxlength="15" class="form-control " name="gst" id="gst"
                                    style="text-transform: uppercase;">
                            </div>
                        </div>
