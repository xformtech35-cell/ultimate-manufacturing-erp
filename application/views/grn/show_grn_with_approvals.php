...
<style>
    ...
    .grn-grid-table > tbody > tr > th,
    .grn-grid-table > tbody > tr > td,
    .grn-grid-table > thead > tr > th,
    .grn-grid-table > thead > tr > td {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <ol class="breadcrumb">
                    ...
                    <li class="active">GRN Details with Approvals</li>
                </ol>
            </section>
                            ...
                            <div class="box-header">
                                ...
                                <div class="pull-right">
                                    <div class="col-md-3" style="margin-left: 10px;">
                                        <a href="javascript:void(0);" onclick="window.history.back()" class="btn btn-primary btn-sm"><i class="fa fa-close"></i> Close</a>
                                    </div>

                                    <div class="col-md-3" style="margin-left: 10px;">
                                        <!-- Export PDF -->
                                        <a class="btn btn-primary btn-sm" id="exportpdf" href="<?php echo base_url(); ?>Pdf/grn_pdf/<?php echo isset($grn_data_group['grn_number']) ? $grn_data_group['grn_number'] : ''; ?>">Export As PDF</a>
                                    </div>
                                ...
                                <div class="shadows1">
                                    <div class="row">
                                        <section class="contemporary-template__header">
                                            <div class="col-md-8">
                                                <div class="contemporary-template__header__logo grn-logo-left">
                                                    <?php if (!empty($settings['company_logo'])): ?>
                                                        <img class="contemporary-template__business-logo" src="<?php echo base_url() . $settings['company_logo']; ?>" width="50%" height="25%">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
