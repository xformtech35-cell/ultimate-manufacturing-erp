...
<head>
    ...
    $invoice_data_group = isset($invoice_data_group) && is_array($invoice_data_group)
        ? array_merge($invoice_defaults, $invoice_data_group)
        : $invoice_defaults;
    $show_invoice = isset($show_invoice) && is_array($show_invoice) ? $show_invoice : array();
    $stamp = isset($stamp) ? $stamp : 'no';
    $invoice_date = !empty($invoice_data_group['invoice_date'])
        ? date('d-m-Y', strtotime($invoice_data_group['invoice_date']))
        : 'N/A';
    ?>
    <style>
        * {
        ...
        .col-tax { width: 8%; text-align: center; } /* Shown when CGST/SGST are hidden */
...
<body>
    <div class="invoice-container">
        <?php
        $gst_type_row = '';
        // Defaults for cases where no line items are available.
        $colspan = "11";
        $colspan1 = "4";
        $colspan2 = "7";
        $colspan3 = "10";
        ...
        foreach ($show_invoice as $key) {
            if ($key->gst_type == 'I') {
                // IGST case: columns include discount
                $colspan = "10";      // For tax summary
                $colspan1 = "4";      // For bank details left column span
                $colspan2 = "6";      // For signature right column span
                $colspan3 = "9";      // For total rows colspan (before tax, etc) - adjusted for discount column
                $colspan4 = "1";
                $colspan5 = "3";
                $colspan6 = "2";
                $colspan7 = "4";
                ...
                // CGST/SGST case: columns include discount
                $colspan = "11";      // For tax summary
                $colspan1 = "4";      // For bank details left column span
                $colspan2 = "7";      // For signature right column span
        ...
        <table class="company-header">
             <tr>
                ...
                <td width="60%" valign="top">
                    ...
                    <div><span class="label-sm">Address :</span> <?php echo $settings['address']; ?></div>
                    <div><span class="label-sm">State Code :</span> <?php echo $settings['state_code']; ?></div>
            ...
            <tr>
                ...
                <td width="34%" valign="top">
                    ...
                    <table class="no-border-table" style="font-size:8.5px;">
                        ...
                        <tr><td class="label-sm">Invoice Date:</td><td><?php echo $invoice_date; ?></td></tr>
        ...
        <table id="dynamic_field">
            ...
            <!-- Items Table Header - Discount column after Price (matching proforma layout) -->
            ...
            // Add blank rows - dynamically adjust columns based on GST type with discount column
            if ($gst_type_row == 'I') {
            ...
            <!-- Total Calculation Section with discount consideration -->
            <?php foreach ($show_invoice as $key) { ?>
                <?php if ($key->gst_type != 'I') { ?>
                    <!-- CGST/SGST Case with discount column -->
                ...
                <?php } else { ?>
                    <!-- IGST Case with discount column -->
                    <tr class="total-section">
                        <td colspan="3" class="text-right"><b>Total Qty:</b></td>
                        <td><?php echo $formatted_total_qty; ?></td>
