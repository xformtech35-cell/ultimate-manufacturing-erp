...
<html>
    ...
    <body>
        ...
        <table  border="2">
            <caption style="font-size: 1.3em;">Vtech Solutions</caption>
        </table>
            <b style="font-size: 1.2em;">ITEMWISE NON GST INVOICE REGISTER FROM <?php echo $from_date ?> TO <?php echo $to_date ?></b>
        <table> 
                <tr>
            ...
            foreach ($item_wise_report as $key) {
                ...
                <tr> 
                    ...
                    <td  class="text-right">
                        <?php $grand_total = $key->total;  echo number_format($grand_total, 2); ?>
                    </td>
