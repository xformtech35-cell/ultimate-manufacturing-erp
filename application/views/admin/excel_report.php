...
$objPHPExcel->getActiveSheet()->getCell('A1')->setValue('Invoice Report')->getStyle('A1:G1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
header('Content-Disposition: attachment;filename="GST Invoice Report.xlsx"');
