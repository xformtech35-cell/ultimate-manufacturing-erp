...
<html moznomarginboxes mozdisallowselectionprint>
    <head>
        ...
        <title> Payment Voucher <?php echo $flag; ?></title>
...
<!--        <link href="<?php echo base_url(); ?>printme/main.css" rel="stylesheet">
    ...
    <body>
        ...
        <center><table border="1" cellpadding="2" id="dynamic_field">  
            <caption style="font-size: 1.3em;"> Payment Voucher <?php echo $flag; ?></caption>
            <tr>
            ...
            <tr>
                ...
                <td> <?php echo $show_voucher_data['payment'] ?></td>
            </tr>
            
            <!-- <tr>
                <td>
                    Ref. <?php echo $show_voucher_data['invoice_number_fk'] ?> &nbsp; &nbsp; &nbsp;<?php echo $show_voucher_data['invoice_pay_date'] ?> &nbsp; &nbsp; &nbsp;<?php echo $show_voucher_data['payment'] ?>
                </td>
                <td> </td>
            </tr> -->
              <tr>
                <td>
                     Through -  <?php echo $show_voucher_data['payment_bank'] ?>
                </td>
                <td> </td>
            </tr>
                <tr>
                <td>
                     ...
                     Amount in words -  <?php   // include amount_convert
                      require( APPPATH . '/third_party/amount_convert.php'); 
                          echo number_to_word($show_voucher_data['payment']) .  ' Only';     
             ...
             <tr>
                 <td>Total </td>
                <td>
                       <?php echo $show_voucher_data['payment'] ?>
                </td>
