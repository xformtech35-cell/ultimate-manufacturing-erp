...
<html>
            ...
            <div class="row" class="shadows1">
                ...
                <div class="row" id="dataexample3">
                    ...
                    <div class="col-md-2">
                        <div class="panel-body">
                            <p id="hide_url">
                                <?php $url = base_url() . 'Pdf/index/' . $estimates_data_group['number_fk']; ?>
            ...
            <div class="row">
                <div>
                    <div class="col-md-8">
                        ...
                        <div>
                            <div class="col-sm-8">
                                <?php echo $estimates_data_group['company_name']; ?>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="col-sm-8">
                                <span class="wv-text--strong hide"><b>GST Number:</b><?php if ($estimates_data_group['gst']) { ?>
                        ...
                        <div>
                            <div class="col-sm-8">
                                <span class="wv-text--strong hide"><b>PAN Number:</b><?php if ($estimates_data_group['pancard']) { ?>
                        ...
                        <div>
                            <div class="col-sm-8">
                                <b>Customer Name: <?php echo $estimates_data_group['fullname']; ?></b><br>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div>
                            <label class="control-label"><b>Quotation Number:</b></label><?php echo $estimates_data_group['number_fk']; ?>
                        </div>

                        <div>
                            <label class="control-label"><b>Quotation Date:</b></label><?php echo $estimates_data_group['date']; ?>
                        </div>

                        <div>
                            <label class="control-label"><b>Expires on: </b></label><?php echo $estimates_data_group['exp_date']; ?>
                        </div>

                        <div>
                            <span class="non_gst_total"><label class="control-label non_gst_total"><b>Grand Total (INR): </b></label><?php echo number_format($estimates_data_group['basic_total'], 2); ?></span>
                            <span class="gst_total"> <label class="control-label gst_total"><b>Grand Total (INR): </b></label><?php echo number_format($estimates_data_group['total'], 2); ?></span>
                            <span class="igst_total"> <label class="control-label igst_total"><b>Grand Total (INR): </b></label><?php echo number_format($estimates_data_group['total'], 2); ?></span>
                        </div>

                        <div>
                            <label class="control-label"><b>Enquiry: </b></label><?php if ($estimates_data_group['enquiry'] == '1') { ?>
                                <?php echo "By Mail"; ?>
                            <?php } else { ?>
                                <?php
                                echo "By Verbal";
                        ...
                        <div id="dataexample2">
                            <table  class="table wv-table__row"> 
                                ...
                                foreach ($show_quotation as $key) {
                                    ?>
                                    <tr> 
                                        <td><span id="" class=""></span> <?php echo $i; ?></td>
    ...
    <?php echo number_format($key->amount, 2); ?><input type="hidden" name="amount[]" id="amount<?php echo $i; ?>" class="form-control name_list amount_auto" value="<?php echo $key->amount; ?>"/>
            ...
            <div class="row" id="dataexample3">
                ...
                <div class="col-md-2">
                    <label class="control-label"><b>Grand Total (INR): </b></label><?php echo number_format($estimates_data_group['total'], 2); ?>
                </div>
            </div>
