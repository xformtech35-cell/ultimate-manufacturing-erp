        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Assets Details</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Add Assets Details</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay"  method="post" action="<?php echo base_url(); ?>AssetController/add_asset" enctype="multipart/form-data">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach ($asset_result as $key) { ?>
                                            ...
                                            <td><a href="<?php echo base_url() . 'AssetController/delete_asset_by_id/' . $key->asset_id; ?>" class="btn btn-danger" role="button" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                            </tr>
                                        <?php $i++; } ?>
                                    </tbody>
                                </table>
