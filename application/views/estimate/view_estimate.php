                        ...
                        <div class="box box-info">
                            <div class="box-header" style="padding-bottom: 10px;">
                                <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px;">
                                    <h3 class="box-title" style="margin:0;">Quotation Details</h3>
                                    <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                        <form action="<?php echo base_url(); ?>EstimateController/get_monthyearwise_record" method="post" style="margin:0; display:flex; gap:4px; align-items:center;">
                                            <input type="text" class="form-control onlymonth input-sm" name="month_year" id="month_year" onkeydown="return false;" autocomplete="off" required="" placeholder="Select Month/Year" style="width:160px;">
                                            <button class="btn btn-primary btn-sm" name="submit" value="">Submit</button>
                                        </form>
                                        <a href="<?php echo base_url(); ?>EstimateController/index?str=All" class="btn btn-info btn-sm"><i class="fa fa-list"></i> Show All</a>
                                        <a href="<?php echo base_url('EstimateController/export_all_quotations'); ?>" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Export Quotation</a>
                                        <a href="<?php echo base_url(); ?>EstimateController/create_gst_estimate" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create Quotation</a>
                                    </div>
                                </div>
                            </div>
