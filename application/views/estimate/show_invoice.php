...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url() . 'EstimateController/index/' ?>">Invoice</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <label for="inputEmail3" name="number" id="number" class="col-sm-12 control-label">
                            <h2>Invoice:<?php echo isset($estimates_data_group['number_fk']) ? $estimates_data_group['number_fk'] : ''; ?></h2>
                        </label>
                        <!--</div>-->
                        <!-- /.box-header -->
                        <!--<div class="box-body">-->
    ...
    <div class="col-xs-6" style="padding-left:0;">
        <div class="btn-group" role="group">
            ...
            <form method="POST" action="<?php echo base_url(); ?>EstimateController/duplicate_quote" style=" margin-right:2px;">
                <input type="hidden" class="form-control input-sm" name="id" id="id" required="" value="<?php echo $estimates_data_group['id']; ?>">
                <button id="duplicateBtn" class="btn btn-primary" role="button" type="submit">Duplicate</button>
            </form>
                        ...
                        <div class="shadows1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contemporary-template__header__info">
                                        ...
                                        <div class="wv-heading--subtitle"><b>Invoice Details :</b></div>
                                        <br>
                                        <span class="wv-text--strong"><b>Invoice Number :</b> <?php echo isset($estimates_data_group['number_fk']) ? $estimates_data_group['number_fk'] : ''; ?></span><br>
                                        <span class="wv-text--strong"><b>Invoice Date :</b> <?php echo date('d-m-Y', strtotime($estimates_data_group['date'])); ?></span><br>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered quotation-grid-table" id="dynamic_field">
                                    ...
                                    $i = 1;
                                    $colspan = 0;
                                    $itemsToShow = 20; // Set to show 18 items
