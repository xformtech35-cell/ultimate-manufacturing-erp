...
$form_action  = $is_edit_mode
    ? base_url() . 'InventoryController/edit_indirect_individual'
    : base_url() . 'InventoryController/add_indirect_individual';
?>
    ...
    <div class="wrapper">
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Indirect Indivisual Master</h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url() . 'Home/index/'; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="#">Indirect</a></li>
                    <li class="active">Indivisual Master</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Indivisual Master Details</h3>
                            </div>
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay" method="post" action="<?php echo $form_action; ?>">
                                    ...
                                    <div class="card-footer small text-muted">
                                        <?php if ($is_edit_mode) { ?>
                                            <a href="<?php echo base_url() . 'InventoryController/indirect_individual_master'; ?>" class="btn btn-default">Cancel</a>
                                ...
                                <tbody>
                                    <?php $i = 1; foreach ($records as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'InventoryController/indirect_individual_master?edit_id=' . $row->id; ?>"
                                                   class="btn btn-primary" role="button">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url() . 'InventoryController/delete_indirect_individual/' . $row->id; ?>"
