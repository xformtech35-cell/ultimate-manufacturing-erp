...
$purchase_bill_data_group = isset($purchase_bill_data_group) && is_array($purchase_bill_data_group) ? $purchase_bill_data_group : array();
$purchase_bill_data_group = array_merge(array(
    'number' => '',
    'company_name' => '',
    'invoice_no' => '',
    'invoice_file' => '',
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url() . 'SupplierController/show_purchase_bill/' ?>">Purchase Voucher</a></li>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Edit Purchase Voucher</h3>
                            ...
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay" name="add_name" id="add_name" method="post" action="<?php echo base_url(); ?>SupplierController/edit_purchase_bill" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <label for="inputEmail3" name="number" id="number" class="col-sm-12 control-label"><h2> Purchase Voucher:<b> <?php echo $purchase_bill_data_group['number']; ?></b></h2></label>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control input-sm company_search_name" name="supplier_id" id="supplier_id" required id="">
                                                        ...
                                                        <?php
                                                        $company_name = $purchase_bill_data_group['company_name'];
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?php echo $purchase_bill_data_group['invoice_no']; ?>" class="form-control" name="invoice_no" id="invoice_no">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <small class="text-muted">Upload invoice copy (PDF, DOC, DOCX, XLS, XLSX, JPG, JPEG, PNG)</small>
                                                    <?php if (!empty($purchase_bill_data_group['invoice_file'])): ?>
                                                        <br><a href="<?php echo base_url('Download/download_invoice_file/' . urlencode($purchase_bill_data_group['invoice_file'])); ?>" class="btn btn-xs btn-info" title="Download Invoice File"><i class="fa fa-download"></i> Download Invoice</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control   input-sm holedate" autocomplete="off" name="date" id="date" required="" value="<?php echo $purchase_bill_data_group['po_date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm payment-due-date-check holedate" autocomplete="off" name="payment_due_date" id="payment_due_date" required="" value="<?php echo $purchase_bill_data_group['payment_due_date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control input-sm "  name="status" id="status">
                                                        ...
                                                        <?php if ($purchase_bill_data_group['status'] == 1) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if ($purchase_bill_data_group['status'] == 2) { ?>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_bill_data_group['status'] == 3) { ?>
                                                            <option value="1" >Draft</option>
                                                            <option value="2">Sent</option>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_bill_data_group['status'] == 4) { ?>
                                                            <option value="1">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_bill_data_group['status'] == 5) { ?>
                                                            <option value="1" selected="">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            <option value="4">Approved</option> 
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_bill_data_group['status'] == 6) { ?>
                                                            <option value="1">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            <option value="4">Approved</option> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" value="<?php echo $purchase_bill_data_group['expenditure_type']; ?>" name="expenditure_type" id="expenditure_type" >
                                                 </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 hide">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?php echo $purchase_bill_data_group['pv_subheading'] ?? ($purchase_bill_data_group['subheading'] ?? ''); ?>" class="form-control" name="pv_subheading" id="pv_subheading">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="pv_footer" id="pv_footer" rows="3"><?php echo $purchase_bill_data_group['pv_footer'] ?? ($purchase_bill_data_group['footer'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="pv_memo" id="pv_memo" rows="3"><?php echo $purchase_bill_data_group['pv_memo'] ?? ($purchase_bill_data_group['memo'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            foreach ($show_purchase_bill as $key) {
                                                ...
                                                <tr> 
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="form-control input-sm" name="po_bill_id[]" id="quotation_id<?php echo $i; ?>"  value="<?php echo $key->po_bill_id; ?>">
                                                    </td> 
                                                    <td>
                                                    ...
                                                    <td><input type="text" name="hsn[]" value="<?php echo $key->hsn_code; ?>" id="hsn<?php echo $i; ?>" required=""  readonly class="form-control input-sm name_list" readonly="" /></td> 
                                                    ...
                                                    <td>
                                                        <?php if ($i == 1) { ?>
                                                            ...
                                                            <?php if ($key->gst_type != 'S') { ?>
                                                                <input type="hidden" class="form-control input-sm"   name="gst_check" value="" id="gst_check">
                                                        ...
                                                        <?php } else { ?>
                                                            <button type="button" name="remove" title="edit_po_bill" id="remove<?php echo $i; ?>" class="btn btn-danger btn-xs btn_remove">X</button>  
                                                        <?php } ?>
                                                    </td> 
                                                </tr>  
                                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_terms_and_conditions" id="pv_terms_and_conditions" rows="3"><?php echo $purchase_bill_data_group['pv_terms_and_conditions'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pv_payment_terms" class="col-sm-2 control-label">Payment Terms</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_payment_terms" id="pv_payment_terms" rows="3"><?php echo $purchase_bill_data_group['pv_payment_terms'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pv_process_schedule" class="col-sm-2 control-label">Process Schedule</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_process_schedule" id="pv_process_schedule" rows="3"><?php echo $purchase_bill_data_group['pv_process_schedule'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_note" id="pv_note" rows="3"><?php echo $purchase_bill_data_group['pv_note'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pv_taxes" class="col-sm-2 control-label">Taxes</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_taxes" id="pv_taxes" rows="3"><?php echo $purchase_bill_data_group['pv_taxes'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pv_exclusions" class="col-sm-2 control-label">Exclusions</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="pv_exclusions" id="pv_exclusions" rows="3"><?php echo $purchase_bill_data_group['pv_exclusions'] ?? ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
