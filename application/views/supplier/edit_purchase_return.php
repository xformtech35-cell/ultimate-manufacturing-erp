...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay" name="add_name" id="add_name" method="post" action="<?php echo base_url(); ?>SupplierController/edit_purchase_return" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <label for="inputEmail3" name="number" id="number" class="col-sm-12 control-label"><h2>GST Debit Note:<b> <?php echo $purchase_return_data_group['number']; ?></b></h2></label>
                                            </div>
                                        </div>    
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control input-sm company_search_name" name="supplier_id" id="supplier_id" required>
                                                        ...
                                                        <?php
                                                        $company_name = $purchase_return_data_group['company_name'];
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control   input-sm holedate" autocomplete="off" name="date" id="date" required="" value="<?php echo $purchase_return_data_group['po_date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm payment-due-date-check holedate" autocomplete="off" name="delivery_date" id="delivery_date" required="" value="<?php echo $purchase_return_data_group['delivery_date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                         ...
                                         <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control input-sm "  name="status" id="status">
                                                        ...
                                                        <?php if ($purchase_return_data_group['status'] == 1) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if ($purchase_return_data_group['status'] == 2) { ?>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_return_data_group['status'] == 3) { ?>
                                                            <option value="1" >Draft</option>
                                                            <option value="2">Sent</option>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_return_data_group['status'] == 4) { ?>
                                                            <option value="1">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_return_data_group['status'] == 5) { ?>
                                                            <option value="1" selected="">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            <option value="4">Approved</option> 
                                                            ...
                                                            <option value="6">Canceled</option> 
                                                        <?php } ?>
                                                        <?php if ($purchase_return_data_group['status'] == 6) { ?>
                                                            <option value="1">Draft</option>
                                                            <option value="2">Sent</option>
                                                            <option value="3">Viewed</option>
                                                            <option value="4">Approved</option> 
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" value="<?php echo $purchase_return_data_group['ref_no']; ?>" class="form-control" name="ref_no" id="ref_no">
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="col-md-6 hide">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?php echo $purchase_return_data_group['subheading']; ?>" class="form-control" name="subheading" id="subheading">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="footer" id="footer" rows="3"><?php echo $purchase_return_data_group['footer']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="memo" id="memo" rows="3"><?php echo $purchase_return_data_group['memo']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            foreach ($show_purchase_return as $key) {
                                                ...
                                                <tr> 
                                                    <td>
                                                        ...
                                                        <input type="hidden" class="form-control input-sm" name="po_return_id[]" id="quotation_id<?php echo $i; ?>"  value="<?php echo $key->po_return_id; ?>">
                                                    </td> 
                                                    <td>
                                                ...
                                                <td class="gst_per"><input type="text" readonly="" name="gst_per[]" value="<?php echo $key->gst; ?>" id="gst_per<?php echo $i; ?>" class="form-control input-sm name_list" /></td> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            <button type="button" name="remove" title="edit_po_return" id="remove<?php echo $i; ?>" class="btn btn-xs btn-danger btn_remove">X</button>  
                                                        <?php } ?>
                                                    </td> 
                                                </tr>  
                                                <?php
    ...
    <script>
        ...
        function updateGrandTotalWords() {
            ...
            $('#word2').text('Grand Total in Words: ' + grandTotalWords);
        }
        ...
        $(document).ready(function () {
            ...
            var igst_edit_hide_show = $("#igst_edit_hide_show").val();
            if (igst_edit_hide_show == "igst_edit_hide_show") {
                $(".gst").hide();
