                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <form action="<?php echo base_url(); ?>SalesReturnController/get_sales_return_datewise_record" method="post" style="margin:0; display:flex; gap:6px; align-items:center;">
