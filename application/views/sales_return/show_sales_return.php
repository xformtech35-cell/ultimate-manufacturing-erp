...
?>
<style>
    .salesreturn-logo-left {
        text-align: left;
    }

    .salesreturn-logo-left img {
        display: inline-block;
        margin-top: 26px;
    }

    .salesreturn-grid-table {
        border-collapse: collapse;
        border: 2px solid #2f2f2f;
        background-color: #fff;
    }

    .salesreturn-grid-table > tbody > tr > th,
    .salesreturn-grid-table > tbody > tr > td,
    .salesreturn-grid-table > thead > tr > th,
    .salesreturn-grid-table > thead > tr > td {
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                        <label for="inputEmail3" name="number" id="number" class="col-sm-12 control-label"><h2> Credit Note:<?php echo $sales_return_data_group['number']; ?></h2></label>


                        <div class="row" style="padding:2%; margin-left:0; margin-right:0;">
    <div class="col-xs-6" style="padding-left:0;">
        <div class="btn-group" role="group">
            <a href="<?php echo base_url(); ?>SalesReturnController/edit_sales_return_details?number=<?php echo $sales_return_data_group['number'] . '&gst_type=' . $gst_type; ?>" class="btn btn-primary" role="button" style="margin-right:5px;">Edit</a>
            <div class="dropdown" style="display:inline-block;">
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    <li><a class="dropdown-item" id="exportpdf" href="<?php echo base_url(); ?>Pdf/download_sales_return/<?php echo $sales_return_data_group['number']; ?>">Export As PDF</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <a href="javascript:void(0);" onclick="window.history.back()" class="btn btn-primary"><i class="fa fa-close"></i> Close</a>
                        ...
                        <div class="shadows1">
                            <div class="row">
                                <section>
                                    <div class="col-md-6">
                                        <div class="salesreturn-logo-left">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="contemporary-template__header__info">
                                            ...
                                            <div class="wv-heading--title"><h1>Credit Note</h1></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                         ...
                                         <span class="wv-text--strong"><b>Vendor Name :</b> <?php echo $sales_return_data_group['company_name']; ?></b></span><br>
                                    <div class="contemporary-template__header__info">
                                            
                                         
                                            
                                            <span class="wv-text--strong"><b>Address :</b> <?php echo $sales_return_data_group['address']; ?></span><br>
                                           <span class="wv-text--strong"><b>GST Number :</b> <?php if ($sales_return_data_group['gst']) { ?>
                                                <?php echo $sales_return_data_group['gst']; ?>
                                            <?php } else { ?>
                                                <?php echo "None Provided";
                                            } ?></span><br>
                                            <span class="wv-text--strong"><b>PAN Number :</b> <?php if ($sales_return_data_group['pancard']) { ?>
                                                <?php echo $sales_return_data_group['pancard']; ?>
                                            <?php } else { ?>
                                                <?php echo "None Provided";
                                            } ?></span><br>
                                            <span class="wv-text--strong"><b> Customer Name :</b> <?php echo $sales_return_data_group['fullname']; ?></span><br>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contemporary-template__header__info">
                                        ...
                                        <span class="wv-text--strong"><b>Return Number :</b> <?php echo $sales_return_data_group['number']; ?></span><br>
                                        <span class="wv-text--strong"><b>Return Date :</b> <?php echo date('d-m-Y', strtotime($sales_return_data_group['date'])); ?></span><br>
                                        <span class="wv-text--strong"><b>Delivery Date :</b> <?php echo $sales_return_data_group['delivery_date']; ?></span><br>
                                        <span class="wv-text--strong"><b>Ref. No.:</b> <?php echo $sales_return_data_group['ref_no']; ?></span><br>
                        ...
                        <table class="table table-bordered salesreturn-grid-table" id="dynamic_field">  
                            <tr>
                                <th>Sr.No.</th>
                                <th>Description</th>
                                <th>HSN Code</th>
                            ...
                            foreach ($show_sales_return as $key) {
                                ...
                                <tr> 
                                    ...
                                    <td><span id="" class=""></span>
                                        <?php echo number_format($key->quantity); ?><input type="hidden" name="quantity[]" value="<?php echo $key->quantity; ?>" id="quantity<?php echo $i; ?>" class="form-control input-sm name_list quantity_auto"/>
                                    </td>
                                        <td><span id="" class=""></span>
                            ...
                            foreach ($show_sales_return as $key) {
                                ...
                                <?php if ($key->gst_type != 'I') { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1"  class="text-left">
                                            <b>₹<?php echo number_format($sales_return_data_group['total'], 2); ?></b> <br>
                                        </td>
                                    </tr>
                                    <tr></tr>
                                    ...
                                    <tr>
                                        <td colspan="11"  class="text-right">
                                            ...
                                            ?>
                                            <b> Grand Total in Words:<?php echo number_to_word($sales_return_data_group['total']); ?> Only.</b><br>
                                        </td>
                                    </tr>
                        ...
                        <div style="text-align: center;">This is Computer Generated Credit Note</div><br>
