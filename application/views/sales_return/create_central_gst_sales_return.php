...
<!--                        <div class="col-md-2">
                        ...
                        <div class="pull-right">
                            <div class="col-md-6">
                                <a href="<?php echo base_url(); ?>SalesReturnController/create_sales_return" id="central_gst" name="central_gst" class="btn btn-primary" role="button">GST</a>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <label for="inputEmail3" name="number" id="number" class="col-sm-12 control-label"><h2>IGST Credit Note:<b> CN/<?php printf("%04d", $sales_return_id+ 1); ?>/<?php echo $financial_year; ?> </b></h2></label>
                                            </div>
                                        </div>    
   ...
   <option value="NEW">+ Add New Product</option>
                                                ...
                                                <td><input type="text" maxlength="5" name="discount[]" id="discount1" class="form-control input-sm name_list discount_auto number-only-validation" value="" /></td>
...
<!--                                            <span id="sgst_amount" name="sgst_amount[]">SGST Amount: ₹0.00</span><br>
        ...
        $(document).ready(function () {
            ...
            $(document).on('DOMSubtreeModified', '#grand_total_amount2', function() {
                updateAmountInWords2();
            });

            function updateAmountInWords2() {
                let grandTotalText = $('#grand_total_amount2').text().replace(/[^0-9.]/g, '');
                let grandTotal = parseFloat(grandTotalText) || 0;
                $('#word2').text(numberToWords(Math.floor(grandTotal)));
            }
...
<!--                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>SalesReturnController/add_supplier" enctype="multipart/form-data">-->
