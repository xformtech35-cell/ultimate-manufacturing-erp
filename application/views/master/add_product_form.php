                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Add Product</h3><br><br>
                            ...
                            <div class="box-body">
                                ...
                                <form class="form-horizontal" id="form_overlay" method="post" action="<?php echo base_url(); ?>MasterController/add_product">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select name="category_id_fk" class="form-control input-sm" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control input-sm"  name="product_master_name" style="text-transform: uppercase" required="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
