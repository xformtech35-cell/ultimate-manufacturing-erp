                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_expenditure_item_report">
                                <div class="box-body">
                                        ...
                                        <div class="col-sm-4">
                                            <select type="text" class="form-control input-sm" name="expense_category" id="expense_category" required="">
                                                ...
                                                <?php foreach ($expense_catgory as $key) { ?>
                                                   ...
                                                   <option value="<?php echo $key->exp_cat ?>"  
                                                            <?php   
                                                            if ($expense_category_str == $key->exp_cat) {
                                                                echo 'selected="selected"';
                                                            }
                                                            ?> ><?php echo $key->exp_cat; ?></option>
                             ...
                             <a href="<?php echo base_url();?>ReportController/get_expenditure_item_report_by_date"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
