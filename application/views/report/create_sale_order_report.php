...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Sale Order Report</li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Sale Order Report</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_sale_order_report">
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control input-sm company_search_name"  name="fullname" id="fullname">
                                                <option value="">Select Customer</option>
                                                <?php foreach ($fullname as $key) { ?>
                                                
                                                 <option value="<?php echo $key->fullname ?>"  
                                                            <?php   
                                                            if ($fullname_str == $key->fullname) {
                                                                echo 'selected="selected"';
                                                            }
                                                            ?> ><?php echo $key->fullname; ?></option>
                                                <?php } ?>  
                                            </select>
                                        </div>
                                    </div>
                         ...
                         <a href="<?php echo base_url(); ?>ReportController/get_sale_order_report"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
 ...
 <tbody>
                                    <?php
                                    $i = 1;
                                    foreach ($sale_order_report as $key) {
                                        ?>
                                        <tr>
                                            <td>
                                               <?php echo $i; ?>
                                         ...
                                         <td><?php echo $key->exp_date; ?> </td>
                                          <td><?php echo $key->status; ?> </td>
                                          <td><?php echo "Sale Order" ?> </td>
