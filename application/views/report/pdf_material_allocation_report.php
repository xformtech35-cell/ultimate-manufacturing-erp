...
<head>
    <meta charset="utf-8">
    <title>Material Allocation Report</title>
    <style>
        body {
...
?>
    <div class="header">
        <h2>MATERIAL ALLOCATION REPORT</h2>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 6%;">Project Code</th>
                ...
                <th style="width: 5%; text-align: right;">Alloc Qty</th>
                <th style="width: 6%; text-align: right;">Cost Price</th>
                <th style="width: 7%; text-align: right;">Total Cost</th>
                <th style="width: 6%; text-align: right;">Pend Qty</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo !empty($row->allocated_date) ? date('d-m-Y', strtotime($row->allocated_date)) : ''; ?></td>
                    <?php if ($show_project_cols): ?>
                    ...
                    <td class="text-right"><?php echo number_format($alloc_qty, 2); ?></td>
            ...
            <?php } else { ?>
                <tr>
                    <td colspan="<?php echo $show_project_cols ? '14' : '12'; ?>" class="text-center">No records found.</td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
