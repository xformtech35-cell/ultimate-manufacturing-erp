        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Sale Order Item Report</li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Sale Order Item Report</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_sale_order_item_report">
                                <div class="box-body">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control input-sm company_search_name"  name="product_name" id="product_name">
                                                ...
                                                <?php foreach ($item_name as $key) { ?>
                                                 ...
                                                 <option value="<?php echo $key->salesorder_id ?>"  
                                                            ><?php echo $key->product_name; ?></option>
                                                
                                                
                                                
                                                    <option value="<?php echo  $key->product_name; ?>"><?php echo $key->product_name; ?></option> 
                                                <?php } ?>  
                                            </select>
                                        </div>
                                    </div>
                              ...
                              <a href="<?php echo base_url(); ?>ReportController/get_sale_order_item_report"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
