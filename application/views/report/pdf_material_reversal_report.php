...
<head>
    <meta charset="utf-8">
    <title>Material Reversal Report</title>
    <style>
        body {
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 8%;">Reversal No.</th>
                ...
                <th style="width: 5%; text-align: right;">Rev Qty</th>
        ...
        <tbody>
            ...
            <?php if (!empty($result)) { ?>
                <tr class="total-row">
                    ...
                    <td class="text-right"><?php echo number_format($total_reversed, 2); ?></td>
                    <td></td>
