...
$supplier_id = isset($supplier_id) ? $supplier_id : '';
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Supplier Statement Report</li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Supplier Statement Report</h3>
                            </div>
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_supplier_statement_report">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">From Date<span style="color:red;">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control backdate" name="from_date" required value="<?php echo $from_date; ?>" onkeydown="return false;" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">To Date<span style="color:red;">*</span></label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control backdate" name="to_date" required value="<?php echo $to_date; ?>" onkeydown="return false;" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="supplier_id" required>
                                                ...
                                                <?php foreach ($supplier_list as $s) { ?>
                                                    <option value="<?php echo $s->supplier_id; ?>" <?php if ($supplier_id == $s->supplier_id) echo 'selected'; ?>>
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_supplier_statement_report_xlsx">
                                <button class="btn btn-success pull-right" style="margin:10px;">Export to Excel</button>
                            </a>
                            ...
                            <table class="table table-bordered table-striped" style="margin-top:10px;">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $row) {
                                        $is_bill = (isset($row['row_type']) && $row['row_type'] === 'bill');
                                        $bg = $is_bill ? '' : 'background:#f9f9f9;';
                                    ?>
                                    <tr style="<?php echo $bg; ?>">
                                        <td><?php echo $is_bill ? $sr++ : ''; ?></td>
                                        <td><?php echo $row['bill_date']; ?></td>
                                        <td><?php echo $row['bill_number']; ?></td>
                                        <td><?php echo isset($row['voucher_number']) ? $row['voucher_number'] : ''; ?></td>
                                        <td class="text-right"><?php echo ($is_bill && $row['total'] !== '') ? number_format($row['total']) : ''; ?></td>
                                        <td class="text-right"><?php echo (!$is_bill && $row['pay_amount'] !== '') ? number_format($row['pay_amount']) : ''; ?></td>
                                        <td class="text-right"><?php echo ($row['balance'] !== '') ? number_format($row['balance']) : ''; ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
