    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Customer Report By Item 
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url() . 'Home/index/' ?>"><i class="fa fa-dashboard"></i>Home</a></li>
                    <li><a href="#">Report</a></li>
                    <li class="active">Customer Report By Item </li>
                </ol>
            </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_customer_report_item">
                                <div class="box-body">
                                            ...
                                            <select class="form-control input-sm company_search_name"  name="product_name" id="product_name">
                                                ...
                                                <?php foreach ($product_name as $key) { ?>
                                                 ...
                                                 <option value="<?php echo $key->product_name ?>"  
                                                            <?php   
                                                            if ($product_name_str == $key->product_name) {
                                                                echo 'selected="selected"';
                                                            }
                                                            ?> ><?php echo $key->product_name; ?></option>
                                                
                                                    <!--<option value="<?php// echo $key->customer_id . '$' . $key->company_name; ?>"><?php //echo $key->company_name; ?></option>--> 
                                                <?php } ?>  
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_item_report_by_customer"><button class="btn btn-success pull-right">Export to Excel</button></a>
