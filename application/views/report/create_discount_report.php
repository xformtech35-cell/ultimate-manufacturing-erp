                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_discount_report">
                                <div class="box-body">
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_discount_report"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
...
<tbody>
                                    ...
                                    <?php
                                    $i = 1;
                                    foreach ($discount_report as $key) {
                                        ?>
                                        <tr>
                                            <td>
                                               <?php echo $i; ?>
