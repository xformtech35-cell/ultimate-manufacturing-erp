...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Sales Tax Report </h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_sale_tax_report">
                                <div class="box-body">
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_sale_tax_report"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
 ...
 <tbody>
                                    ...
                                    <?php
                                    $i = 1;
                                    foreach ($sale_tax_report as $key) {
                                        ?>
                                        <tr>
                                            <td>
                                               <?php echo $i; ?>
