        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Purchase Order Item Report</li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Purchase Order Item Report</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->                                                                                                                                   
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_purchase_order_item_report">
                                <div class="box-body">
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_purchase_order_item_report"><button class="btn-sm btn btn-success pull-right">Export to Excel</button></a>
...
<tbody>
                                    <?php
                                    $i = 1;
                                    foreach ($purchase_order_item_report1 as $key) {
                                        ?>
                                        <tr>
                                            <td>
                                               <?php echo $i; ?>
