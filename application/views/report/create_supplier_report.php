                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->                      
                            <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>ReportController/create_supplier_report">
                                <div class="box-body">
                            ...
                            <a href="<?php echo base_url(); ?>ReportController/get_supplier_report_by_date"><button class="btn btn-success pull-right">Export to Excel</button></a>
