...
$sheet->setCellValue('A1', 'GSTR 2 Report (Purchase Bills)');
...
foreach ($gstr2_report as $row) {
    ...
    $sheet->setCellValue('F' . $rowCount, 'Purchase');
...
$file_name = 'GSTR2_Report_' . $from_date . '_' . $to_date . '.xlsx';
