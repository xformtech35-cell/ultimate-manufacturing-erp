...
if(!isset($purchase_report) || empty($purchase_report)) {
    // Create a simple spreadsheet with error message
    $spreadsheet = new Spreadsheet();
    $sheet = $spreadsheet->getActiveSheet();
    $sheet->setCellValue('A1', 'No purchase report data found for the selected date range');
    $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(14);
    $sheet->getStyle('A1')->getFont()->getColor()->setARGB(Color::COLOR_RED);
    
    $file_name = 'Purchase_Report_No_Data.xlsx';
...
if($rowCou > 1) {
    ...
    $sheet->setCellValue('B' . $totalRow, 'TOTAL PURCHASE AMOUNT:');
...
$sheet->setCellValue('C' . $summaryRow, 'Average Purchase: ₹ ' . number_format(($rowCou > 1 ? $total_amount / ($rowCou - 1) : 0), 2));
...
$sheet->setCellValue('A' . $footerRow, 'This is a system-generated purchase report. For any discrepancies, please contact the purchase department.');
