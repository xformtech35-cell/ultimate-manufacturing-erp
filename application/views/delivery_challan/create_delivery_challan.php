        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url() . 'DeliveryChallanController/index/' ?>">Invoice</a></li>
                ...
                <div class="row" style="padding:2%">
                    <div class="pull-left">
                        ...
                        <div class="pull-right">
                            <div class="col-md-6">
                                <a href="<?php echo base_url(); ?>DeliveryChallanController/create_central_gst_delivery_challan" id="central_gst" name="central_gst" class="btn btn-primary" role="button">IGST</a>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <label for="inputEmail3" name="invoice_number" id="invoice_number" class="col-sm-12 control-label"> <h2>GST Delivery Challan:<b>DC/<?php printf("%04d", $invoice_id + 1); ?>/<?php echo $financial_year; ?></b> </h2></label>
...
<!--                                            <div class="form-group row">
                                    ...
                                    <table class="table table-bordered" id="dynamic_field">  
                                            ...
                                            <tr>  
                                                ...
                                                <td>                                            <button type="button" name="add_gst" id="add_gst" class="btn btn-xs btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                                                </td>  
                                            </tr>  
                                        </table>  
                                        <div align="center">
...
<!--                <form class="form-horizontal form_overlay" method="post" action="<?php echo base_url(); ?>DeliveryChallanController/add_customer" enctype="multipart/form-data">-->
...
<script type="text/javascript">
    function updateTotalQty() {
        ...
        $('#total_item_qty_display').text(total);
    }
