                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <form action="<?php echo base_url(); ?>DeliveryChallanController/get_datewise_record" method="post" style="margin:0; display:flex; gap:6px; align-items:center;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <button class="btn btn-info btn-sm" id="convertToInvoiceBtn" style="margin-left: 5px;" data-toggle="modal" data-target="#bulkConvertModal"><i class="fa fa-file-invoice"></i> Convert to Invoice</button>
                                    </div>
                                </div>
                            </div>
