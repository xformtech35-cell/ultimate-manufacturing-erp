                            ...
                            <div class="box-header" style="padding-bottom: 10px;">
                                <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:8px;">
                                    ...
                                    <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                        ...
                                        <a href="<?php echo base_url('BomController/export_all_boms'); ?>" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Export BOM</a>
                                        <a href="<?php echo base_url(); ?>BomController/create_gst_bom" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i> Create BOM</a>
                                    </div>
                                </div>
                            </div>
