        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"> Edit BOM Details</li>
                </ol>
            </section>
                        ...
                        <div class="box box-info">
                            <div class="box-header">
                                ...
                                <div class="pull-right" style="display: flex; gap: 8px; align-items: center;">
                                    <button type="button" id="btn_import_excel" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Import Excel</button>
                            ...
                            <div class="box-body">
                                ...
                                <?php if (isset($bom_data_group['send_to_mrp']) && $bom_data_group['send_to_mrp'] == 2) { ?>
                                    <div role="alert" class="alert alert-warning" style="border-left: 5px solid #f39c12;">
                                        <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">x</span><span class="sr-only">Close</span></button>
                                        <h4><i class="icon fa fa-warning"></i> MRP Run Executed!</h4>
                                        MRP has already been run for this BOM version (<b><?php echo html_escape($bom_data_group['number']); ?></b>). Saving changes will automatically create and save them under a <b>new revision</b> (e.g. <b><?php echo html_escape(isset($bom_data_group['display_number']) ? $bom_data_group['display_number'] : $bom_data_group['number'] . '/R1'); ?></b>).
                                    </div>
                                <?php } ?>
                                                    ...
                                                    <select class="form-control input-sm select2" name="" id="bom_so_number_select">
                                                        ...
                                                        <?php if(isset($salesorder_list) && !empty($salesorder_list)): ?>
                                                            <?php foreach($salesorder_list as $so): ?>
                                                                <option value="<?php echo htmlspecialchars($so->so_number); ?>" <?php echo (isset($bom_data_group['oc_number']) && $bom_data_group['oc_number'] == $so->so_number) ? 'selected="selected"' : ''; ?>>
...
<div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <input type="hidden" name="edit_bom" value="edit_bom">
                                                ...
                                                <label class="col-sm-12 control-label"><h2>Edit BOM: <b id="bom_number_display"><?php echo isset($bom_data_group['display_number']) ? $bom_data_group['display_number'] : (isset($bom_data_group['number']) ? $bom_data_group['number'] : ''); ?></b></h2></label>
                                            </div>
                                        </div>    

                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <label class="col-sm-5 control-label">Company<span style="color: red;">*</span></label>
                                                <div class="col-sm-7">
                                                    <select class="form-control input-sm company_search_name" name="customer_id" id="customer_id" required="">
                                                        ...
                                                        <?php foreach ($company_name as $key) { ?>
                                                            <option value="<?php echo $key->customer_id; ?>" <?php echo (isset($bom_data_group['customer_id_fk']) && $bom_data_group['customer_id_fk'] == $key->customer_id) ? 'selected="selected"' : ''; ?>><?php echo $key->company_name . " - " . $key->c_code; ?></option> 
                                                        <?php } ?>  
                                                    </select>
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control input-sm company_search_name" name="project_code" id="project_code">
                                                        ...
                                                        <?php foreach ($project_code_result as $key) { ?>
                                                            <option value="<?php echo $key->project_code; ?>" <?php echo (isset($bom_data_group['project_code']) && $bom_data_group['project_code'] == $key->project_code) ? 'selected="selected"' : ''; ?>><?php echo $key->project_code; ?></option> 
                                                        <?php } ?>   
                                                    </select>
                                                </div>
                                            </div>
<?php endif; // Project Master permission ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="customer_code" id="customer_code" value="<?php echo isset($bom_data_group['customer_code']) ? $bom_data_group['customer_code'] : ''; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control alldate input-sm created-date" name="date" id="date" required="" readonly value="<?php echo isset($bom_data_group['date']) && $bom_data_group['date'] != '0000-00-00' ? date('d-m-Y', strtotime($bom_data_group['date'])) : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="form-control input-sm" name="status_main" id="status_main">
                                                        <option value="0" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '0') ? 'selected="selected"' : ''; ?>>Pending</option>
                                                        <option value="1" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '1') ? 'selected="selected"' : ''; ?>>Draft</option>
                                                        <option value="2" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '2') ? 'selected="selected"' : ''; ?>>Sent</option>
                                                        <option value="3" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '3') ? 'selected="selected"' : ''; ?>>Viewed</option>
                                                        <option value="4" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '4') ? 'selected="selected"' : ''; ?>>Approved</option>
                                                        <option value="5" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '5') ? 'selected="selected"' : ''; ?>>Rejected</option>
                                                        <option value="6" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '6') ? 'selected="selected"' : ''; ?>>Canceled</option>
                                                        <option value="7" <?php echo (isset($bom_data_group['status']) && $bom_data_group['status'] == '7') ? 'selected="selected"' : ''; ?>>Under Review</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="project_qty" id="project_qty" value="<?php echo isset($bom_data_group['project_qty']) ? $bom_data_group['project_qty'] : ''; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="system" id="system" value="<?php echo isset($bom_data_group['system']) ? $bom_data_group['system'] : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="location" id="location" value="<?php echo isset($bom_data_group['location']) ? $bom_data_group['location'] : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="capacity" id="capacity" value="<?php echo isset($bom_data_group['capacity']) ? $bom_data_group['capacity'] : ''; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="oc_number" id="oc_number"
                                                        value="<?php echo isset($bom_data_group['oc_number']) ? $bom_data_group['oc_number'] : ''; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered" id="dynamic_field">  
                                            ...
                                            <tbody id="table-body">
                                                ...
                                                if(isset($show_bom) && !empty($show_bom)):
                                                 ...
                                                 ?>
                                                 <tr id="row<?php echo $i; ?>" class="bom-heading-row">
                                                     <td colspan="9">
                                                         ...
                                                         if (isset($key->tag_no) && ($key->tag_no === 'MAIN' || $key->tag_no === 'SUB')) {
                                                             ...
                                                             $descVal = $key->description ?? '';
                                                             if (preg_match('/PIPING|FITTINGS|VALVES|FLANGE|ELBOW|TEE|PIPE|CPVC|UPVC/i', $descVal)) {
                                                                 $isMain = false;
                                                             }
                                                         }
                                                         ?>
                                                         ...
                                                         <input type="text" name="description[]" class="heading-text-input" value="<?php echo htmlspecialchars($key->description ?? ''); ?>" placeholder="Section Heading...">
                                                     </td>
                                                 ...
                                                 <tr id="row<?php echo $i; ?>">  
                                                     <td>
                                                         <select class="form-control input-sm product_name_auto bom_item_search_name name_list" name="product_name[]" id="item_name<?php echo $i; ?>" onchange="myFunction1(this.id)" required="" data-live-search="true" style="max-width: 50px">
                                                             <option value="">Select Product</option>
                                                             <option value="NEW">Add new item</option>
                                                             <?php $hasSelectedMatch = false; ?>
                                                             <?php foreach ($item_name as $item) { ?>
                                                                 <?php
                                                                 $selectedProduct = isset($key->product_name) ? trim($key->product_name) : '';
                                                                 $itemCode = trim($item->code);
                                                                 $itemLabel = trim($item->item_name);
                                                                 $isSelected = ($selectedProduct !== '' && (strcasecmp($selectedProduct, $itemCode) === 0 || strcasecmp($selectedProduct, $itemLabel) === 0));
                                                                 if ($isSelected) {
                                                                     $hasSelectedMatch = true;
                                                                 }
                                                                 ?>
                                                                 <option value="<?php echo $item->code; ?>" <?php echo $isSelected ? 'selected="selected"' : ''; ?>><?php echo (strcasecmp(trim($item->code), trim($item->item_name)) === 0) ? $item->item_name : ($item->code . " - " . $item->item_name); ?></option>
                                                             <?php } ?>  
                                                             <?php if (!empty($selectedProduct) && empty($hasSelectedMatch)) { ?>
                                                                 <option value="<?php echo html_escape($selectedProduct); ?>" selected="selected"><?php echo html_escape(!empty($key->item_name) ? $key->item_name : $selectedProduct); ?></option>
                                                             <?php } ?>
                                                         </select>
                                                         <input type="hidden" name="product_code[]" id="product_code<?php echo $i; ?>" class="product_code" value="<?php echo isset($key->product_name) ? $key->product_name : ''; ?>">
                                                     ...
                                                     <td>
                                                         <input type="text" name="item_name_display[]" id="item_name_display<?php echo $i; ?>" class="form-control input-sm item_name_display" readonly style="background-color: #eee; width: 100%;" value="<?php echo htmlspecialchars($key->item_name ?? ''); ?>">
                                                     </td>
                                                     <td>
                                                     ...
                                                     <td>
                                                         <input type="number" min="1" name="quantity[]" id="quantity<?php echo $i; ?>" class="form-control input-sm" value="<?php echo isset($key->quantity) ? $key->quantity : '1'; ?>" />
                                                     </td> 
                                                     <td>
                                                         <select class="form-control input-sm bom_item_search_unit" name="unit[]" id="unit<?php echo $i; ?>">
                                                     ...
                                                     <td class="text-center" style="white-space: nowrap; vertical-align: middle;">
                                                            <button type="button" class="btn btn-success btn-xs insert-row-below" title="Insert Row Below" style="padding: 2px 7px;"><i class="fa fa-plus"></i></button>
                                                            <button type="button" name="remove" title="Delete Row" id="remove<?php echo $i; ?>" class="btn btn-danger btn-xs btn-remove-bom-row" style="padding: 2px 7px;"><i class="fa fa-times"></i></button>
                                                            <div class="dropdown" style="display:inline-block;">
                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown" title="More Options" style="padding: 2px 6px;"><span class="caret"></span></button>
                                                                <ul class="dropdown-menu dropdown-menu-right" style="min-width: 160px;">
                                                                    <li><a href="#" class="move-row-up"><i class="fa fa-arrow-up"></i>&nbsp; Move Up</a></li>
                                                 ...
                                                 <tr id="row1">  
                                                     <td>
                                                         <select class="form-control input-sm product_name_auto bom_item_search_name name_list" name="product_name[]" id="item_name1" onchange="myFunction1(this.id)" required="" data-live-search="true" style="max-width: 50px">
                                                             <option value="">Select Product</option>
                                                             <option value="NEW">Add new item</option>
                                                             <?php foreach ($item_name as $row) { ?>
                                                                 <option value="<?php echo $row->code; ?>"><?php echo (strcasecmp(trim($row->code), trim($row->item_name)) === 0) ? $row->item_name : ($row->code . " - " . $row->item_name); ?></option>
                                                             <?php } ?>  
                                                         </select>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <textarea class="form-control" name="note" id="note" rows="3" placeholder="Enter any additional notes..."><?php echo isset($bom_data_group['note']) ? $bom_data_group['note'] : ''; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo base_url(); ?>BomController/add_customer">
                    <div class="modal-body">
                        <div class="card-body">
                            <input type="hidden" name="redirect_bom" value="gst">
...
$(document).ready(function() {
    ...
    if ($('#project_code').length > 0) {
        ...
        // Auto-trigger if Project Code is already loaded (for edit page)
        if ($('#project_code').val()) {
            $('#project_code').trigger('change', [true]);
        }
    }
});
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response && response.success) {
                ...
                var activeDropdownId = window.item_id_new || item_id_new;
                if (activeDropdownId) {
...
if (Array.isArray(rawProducts)) {
    for (var idx = 0; idx < rawProducts.length; idx++) {
        ...
        if (p && p.code) {
            ...
            var escapedCode = p.code; // Don't double escape in JavaScript
            var escapedName = p.item_name || p.code;
            var displayVal = (escapedCode.toUpperCase().trim() === escapedName.toUpperCase().trim()) ? 
                escapedName : (escapedCode + ' - ' + escapedName);
...
function hydrateBomItemSelects() {
    $('.bom_item_search_name').each(function() {
        var $select = $(this);
        var currentValue = $select.val();
        var rowId = $select.attr('id') || '';
        var rowIndex = rowId.replace(/^item_name/, '');
        var $row = $('#row' + rowIndex);
        var storedValue = $.trim($row.find('input.product_code').val() || currentValue || '');
        var storedLabel = $.trim($row.find('.item_name_display').val() || '');
        ...
        var resolvedValue = storedValue || currentValue;

        if (resolvedValue && $select.find('option[value="' + resolvedValue.replace(/"/g, '&quot;') + '"]').length === 0) {
            var fallbackText = storedLabel || resolvedValue;
            $select.append('<option value="' + $('<div>').text(resolvedValue).html() + '" selected="selected">' + $('<div>').text(fallbackText).html() + '</option>');
        }
    ...
    for (var k = 0; k < items.length; k++) {
        ...
        if (item.type === 'subheading' || item.product_name === '__HEADING__') {
            ...
            var headingHtml = '<tr id="row' + i + '" class="bom-heading-row">' +
                ...
                '  <button type="button" class="btn btn-danger btn-xs btn-remove-bom-row" title="Remove" style="padding: 1px 5px;">X</button>' +
                '</td>' +
                '</tr>';
        ...
        var rowHtml = '<tr id="row' + i + '">' +
            '<td>' +
            '  <select class="form-control input-sm product_name_auto bom_item_search_name name_list" name="product_name[]" id="item_name' + i + '" onchange="myFunction1(this.id)" required="" data-live-search="true" style="max-width: 50px">' +
                 productOptionsHtml +
            '  </select>' +
            ...
            '  <button type="button" class="btn btn-default btn-xs move-row-up" title="Move Up" style="padding: 1px 5px; margin-right: 2px;"><i class="fa fa-arrow-up"></i></button>' +
            '  <button type="button" class="btn btn-default btn-xs move-row-down" title="Move Down" style="padding: 1px 5px; margin-right: 2px;"><i class="fa fa-arrow-down"></i></button>' +
            '  <button type="button" class="btn btn-danger btn-xs btn-remove-bom-row" id="remove' + i + '" title="Remove Row" style="padding: 1px 5px;">X</button>' +
            '</td>' +
            '</tr>';
...
$(document).ready(function() {
    ...
    $(document).off('select2:opening.bomItemAlert', '.bom_item_search_name');
    $(document).on('select2:opening.bomItemAlert', '.bom_item_search_name', function() {
        alert('Item Code dropdown opened. Please select an item code.');
    });

    $(document).off('mousedown.bomItemAlert click.bomItemAlert', '.bom_item_search_name + .select2 .select2-selection, .select2-container .select2-selection');
    $(document).on('mousedown.bomItemAlert click.bomItemAlert', '.bom_item_search_name + .select2 .select2-selection, .select2-container .select2-selection', function() {
        var $select = $(this).closest('.select2').prev('.bom_item_search_name');
    ...
    // Initialize loaded row count
    if (typeof i === 'undefined') {
        window.i = $('#table-body tr').length;
    }
