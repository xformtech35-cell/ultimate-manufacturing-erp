    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Edit GST Proforma Invoice
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url() . 'Home/index/' ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="<?php echo base_url() . 'ProformaInvoiceController/show_proforma_invoice/' ?>">GST Proforma Invoice</a></li>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Edit GST Proforma Invoice</h3>
                            ...
                            <div class="box-body">
                                ...
                                <form class="form-horizontal form_overlay" name="add_name" id="add_name" method="post" action="<?php echo base_url(); ?>ProformaInvoiceController/edit_proforma_invoice" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control holedate input-sm created-date" name="date" id="date" required="" value="<?php echo $invoice_data_group['date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control holedate input-sm payment-due-date-check" name="payment_due_date" id="payment_due_date" required="" value="<?php echo $invoice_data_group['payment_due_date']; ?>" onkeydown="return false;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control input-sm" name="supplier_code" id="supplier_code" value="<?php echo $invoice_data_group['supplier_code']; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row hide">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="<?php echo $invoice_data_group['invoice_subheading']; ?>" class="form-control" name="invoice_subheading" id="invoice_subheading">
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-bordered" id="dynamic_field">  
                                            ...
                                            foreach ($show_invoice as $key) {
                                                ...
                                                <tr> 
                                                    ...
                                                    <td>
                                                <select style="width: 100px" class="form-control input-sm  item_search_unit"  name="unit[]" id="unit"  required="" data-live-search="true">
                                                ...
                                                <button type="button" name="add_gst" id="add_gst" class="btn btn-xs btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i></button>
                                                            ...
                                                            <?php } else if ($key->gst_type != 'I') { ?>
                                                                ...
                                                                <!-- <button type="button" name="edit_gst" id="edit_gst" class="btn btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i></button>  -->
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <button type="button" name="remove" title="edit_proforma" id="remove<?php echo $i; ?>" class="btn btn-danger btn-xs btn_remove">X</button>  
                                                        <?php } ?>
                                                    </td> 
                                                </tr>  
                                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="proforma_terms_and_conditions" id="proforma_terms_and_conditions" rows="3"><?php echo isset($invoice_data_group['proforma_terms_and_conditions']) ? $invoice_data_group['proforma_terms_and_conditions'] : ''; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="proforma_payment_terms" id="proforma_payment_terms" rows="3"><?php echo isset($invoice_data_group['proforma_payment_terms']) ? $invoice_data_group['proforma_payment_terms'] : ''; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="proforma_process_schedule" id="proforma_process_schedule" rows="3"><?php echo isset($invoice_data_group['proforma_process_schedule']) ? $invoice_data_group['proforma_process_schedule'] : ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="proforma_taxes" id="proforma_taxes" rows="3"><?php echo isset($invoice_data_group['proforma_taxes']) ? $invoice_data_group['proforma_taxes'] : ''; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="proforma_exclusions" id="proforma_exclusions" rows="3"><?php echo isset($invoice_data_group['proforma_exclusions']) ? $invoice_data_group['proforma_exclusions'] : ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-body">
                    <div class="card-body ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">                                            
                                <input type="text" class="form-control input-sm" name="mobile" id="mobile" maxlength="10" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')"/>                                             
                            </div>
                        </div>
