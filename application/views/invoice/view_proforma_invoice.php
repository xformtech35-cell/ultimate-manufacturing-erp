                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <form action="<?php echo base_url(); ?>ProformaInvoiceController/get_datewise_record" method="post" style="margin:0; display:flex; gap:6px; align-items:center;">
                                    ...
                                    <div class="col-md-5">
                                        <a href="<?php echo base_url(); ?>ProformaInvoiceController/index?str=All"><button class="btn btn-success btn-sm"> Show All Proforma Invoice</button></a>
                                        <a href="<?php echo base_url(); ?>ProformaInvoiceController/create_proforma_invoice"><button class="btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i>Create Proforma Invoice</button></a>
                                    </div>
                                </div>
                            </div>
