    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    IGST Proforma Invoice
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url() . 'Home/index/' ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a href="<?php echo base_url() . 'ProformaInvoiceController/index/' ?>">IGST Proforma Invoice</a></li>
                    <li class="active">IGST Proforma Invoice Details</li>
                </ol>
            </section>
                ...
                <div class="row" style="padding:2%">
                    <div class="pull-left">
                        ...
                        <div class="pull-right">
                            <div class="col-md-6">
                                <a href="<?php echo base_url(); ?>ProformaInvoiceController/create_proforma_invoice" id="local_gst" name="local_gst" class="btn btn-primary" role="button">GST</a>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">Create IGST Proforma Invoice</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row ">
                                                ...
                                                <label for="inputEmail3" name="invoice_number" id="invoice_number" class="col-sm-12 control-label"> <h3>IGST Proforma Invoice:<b>PI/<?php printf("%04d", $invoice_id + 1); ?>/<?php echo $financial_year; ?></b> </h3></label>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group row required">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control  currentDateWithSevendays  input-sm payment-due-date-check" required="" name="due_date" id="payment_due_date" onkeydown="return false;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control  currentDateWithSevendays  input-sm" name="delivery_date" id="delivery_date">
                                                </div>
                                            </div>
                                   ...
                                   <!--                                            <div class="form-group row">
                                    ...
                                    <table class="table table-bordered" id="dynamic_field">  
                                            ...
                                            <tr>  
                                                ...
                                                <td><input type="price" name="price[]" id="price1" required="" class="form-control input-sm required_list name_list price_auto" value="0.00" /></td>
                                                ...
                                                <td><button type="button" name="add_gst" id="add_gst" class="btn btn-success btn-xs action-header-btn"><i class="fa fa-plus-circle" aria-hidden="true"></i></button></td>  
                                            </tr>  
                                        </table>  
                                        <div align="center">
